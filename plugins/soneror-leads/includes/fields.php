...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'soneror-leads' ),
				'storm'       => __( 'Storm or hail damage', 'soneror-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'soneror-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'soneror-leads' ),
				'not-sure'    => __( 'Vet inte än', 'soneror-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'soneror-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'soneror-leads' ),
				'research' => __( 'Jag kollar bara priser', 'soneror-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'soneror-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'soneror-leads' ),
		'contacted' => __( 'Kontaktad', 'soneror-leads' ),
		'quoted'    => __( 'Quote sent', 'soneror-leads' ),
		'won'       => __( 'Won', 'soneror-leads' ),
		'lost'      => __( 'Lost', 'soneror-leads' ),
		'spam'      => __( 'Misstänkt spam', 'soneror-leads' ),
	);
}
